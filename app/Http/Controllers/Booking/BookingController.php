...
class BookingController extends Controller
{
    ...
    {
        $phoneNumber = '+255710459064'; // Your WhatsApp number
        $apiKey = 2408280; // Retrieve API key from .env
        $message = urlencode(
            "New Booking Created!\n" .
...
//             return redirect()->back()->with('error', 'Something Went Wrong');
//         }
//         return redirect()->route('login')->with('message', 'Booking Created Successfully');
//     }
